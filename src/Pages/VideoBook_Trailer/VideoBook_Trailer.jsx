...
const Video_Book_Trailer = () => {
  ...
  const faqData = [
      ...
      
    {
      ...
      Remember, you can hire a professional at any point of the process to take care of the rest of the project. Ghostbookwriters handles all the steps in creating book video trailers individually as well as a complete project.
