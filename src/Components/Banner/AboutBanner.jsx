    ...
    <div className='banner-bg-pt1'>
      <div    >
        ...
        <div>
          ...
          <button type="button" class="mt-8 text-white themecolor hover:bg-yellow-500 focus:outline-none  font-medium rounded-full text-sm px-5 py-2.5 text-center me-2 mb-2">Get  Started </button>
        </div>
      </div>
