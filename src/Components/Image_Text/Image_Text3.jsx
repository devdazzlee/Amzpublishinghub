...
const ImageText3 = ({ title, description1, description2, imageSource, statistics }) => {
  return (
    <div className="flex image-text-container items-center mx-auto ">
      ...
      <div className="image-text-container-part2 my-12">
        ...
        <Link to={'/Contact-us'} >
          ...
          <button type="button" className="text-white themecolor hover:bg-yellow-500 focus:outline-none font-medium rounded-full text-sm px-5 py-2.5 text-center me-2 mb-2">Get Started</button>
        </Link>
        <Link to={'/Contact-us'} >

          <button type="button" className="text-white themecolor hover:bg-yellow-500 focus:outline-none font-medium rounded-full text-sm px-5 py-2.5 text-center me-2 mb-2">Free Consultation</button>
        </Link>
        </div>
      </div>
    </div>
